...
echo -e Jarvis: Ipchecker and Macchecker will now be used to perform a system anonymity check
sleep 2
echo Now loading Ipchecker
sleep 2
options/statistics/ipcheck.sh
sleep 2
echo Now loading Macchecker to current assigned address
sleep 2
options/statistics/macchanger.sh
...
if [ "$ANSWER" == "$ANSWER_YES" ]; 
	...
	sleep 1
	options/statistics/memoryusage.sh
